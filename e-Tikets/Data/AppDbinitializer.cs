    ...
    public class AppDbinitializer
    {
                        ...
                        new Cienma()
                        {
                         ...
                         new Cienma()
                         {
                          ...
                          new Cienma()
                          {
                              ...
                              Description = "This is the descriptino of the five cinema"
                          },
                    });
                    context.SaveChanges();
                }
        ...
        public static async Task SeedUsersAndRolesAsync(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                var userManager = serviceScope.ServiceProvider.GetRequiredService<UserManager<ApplicatoinUser>>();
                string adminUserEmail = "admin@app.com";

                var adminUser = await userManager.FindByEmailAsync(adminUserEmail);
                if (adminUser == null)
                {
                    var newAdminUser = new ApplicatoinUser()
                    {
                        FullName = "Admin User",
                        UserName = "admin-user",
                ...
                string appUserEmail = "user@app.com";

                var appUser = await userManager.FindByEmailAsync(appUserEmail);
                if (appUser == null)
                {
                    var newAppUser = new ApplicatoinUser()
                    {
