...
namespace e_Tikets.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicatoinUser> userManager, SignInManager<ApplicatoinUser> signInManager, AppDbContext context)
        {
       ...
       [HttpPost]
        ...
        public async Task<IActionResult> Register(RegisterVM registerVM)
        {
            ...
            var newUser = new ApplicatoinUser()
            {
            ...
            if (newUserResponse.Succeeded)
                ...
                return View("RegisterdCompleted");
